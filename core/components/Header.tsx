                        ...
                        <div className="bg-white shadow-2xl border-t-[5px] border-yellow-500 flex flex-col overflow-hidden">
                            {academicsMenu.map((menuItem, i) => (
                              <Link 
                                ...
                                className="px-6 py-4 text-[11px] font-extrabold tracking-widest flex justify-between items-center cursor-pointer transition-all border-b border-slate-100 text-slate-600 hover:text-[#1e1b4b] hover:bg-slate-50"
