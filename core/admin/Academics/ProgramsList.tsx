...
const ProgramsList: React.FC<ProgramsListProps> = ({ 
  ...
  return (
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-800/50 p-6 rounded-3xl border border-slate-700 shadow-sm">
        <div>
          <h2 className="text-xl font-black text-white uppercase tracking-tight">Management View</h2>
        ...
        <div className="relative w-full md:w-80 group">
          ...
          <input 
            ...
            className="w-full pl-12 pr-4 py-3 bg-slate-900 border border-slate-700 rounded-2xl text-sm text-white focus:border-emerald-500 outline-none transition-all"
          />
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        {sortedList.length === 0 && (
          <div className="py-32 text-center bg-slate-800/50 rounded-[3rem] border-4 border-dashed border-slate-700 max-w-2xl mx-auto shadow-sm">
            <div className="w-20 h-20 bg-slate-900 text-slate-700 rounded-full flex items-center justify-center text-4xl mx-auto mb-6">
