  ...
  return (
    <div className="space-y-12 animate-fade-in">
      ...
      <div className="space-y-8 bg-slate-900/30 p-8 rounded-[2.5rem] border border-slate-700">
        ...
        {/* New Help Desk Configuration */}
        <div className="pt-6 border-t border-slate-700">
          <div className="max-w-md space-y-2">
            <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest ml-1">Roadmap Help Desk Phone</label>
            <input 
              value={formData.helpPhone || ''} 
              onChange={e => updatePageInfo('helpPhone', e.target.value)}
